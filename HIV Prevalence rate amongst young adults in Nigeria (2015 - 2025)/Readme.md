# Title: National HIV prevalence trends (2015–2025)
...
### What’s inside
      •	Prevalence_rate in W&C_Africa — regional/reference prevalence rates (source data or context).
      •	Nigeria_Rate_Extract — extracted rates for the country-level analysis.
      •	Cleaned_Table — cleaned raw data ready for pivoting/aggregation.
      •	Queried_Table — intermediate queries / filtered tables used to build pivot tables.
      •	Pivot_Analysis — pivot tables and summary narrative (primary sheet for the report).
      
### Key assumptions
      •	All prevalence numbers in Pivot_Analysis are percentages (per original Data from UNAIDS).
